...
from examples.hiring_agent.app import CONFIG_PATH, MIGRATION_PATH, TEMPLATE_CORPUS_PATH, UI_PATH
from examples.hiring_agent.application.contracts import HiringApplication
from examples.hiring_agent.application.document_pipeline import candidate_identity_entities
from examples.hiring_agent.application.repositories import PostgresHiringRepository
from examples.hiring_agent.application.workflow import HiringConversationHandler, HiringWorkflow
...
from traccia_runtime.persistence.postgres import PostgresDatabase
...
from traccia_runtime.security.documents import DocumentDisposition, extractor_for, redact_pii
...
def create_hiring_app() -> Any:
    ...
    workflow = HiringWorkflow(TracciaRuntimeClient(container.runtime), repository)
