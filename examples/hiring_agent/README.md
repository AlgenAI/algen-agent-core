...
This example demonstrates a tenant-isolated recruitment review workflow built on Traccia Runtime.
...
Reusable capabilities live in `src/traccia_runtime`:
...
export PGVECTOR_DSN='postgresql://postgres:postgres@localhost:5433/traccia_runtime'
