...
from examples.virtual_teaching_assistant.application import register_teaching_tools
...
from traccia_runtime.types.contracts import RunRequest, RunResult
...
async def ask(question: str) -> RunResult:
    ...
    try:
        ...
        run = container.observability.govern(
            TracciaRuntimeClient(container.runtime).run,
