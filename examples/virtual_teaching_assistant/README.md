...
export TRACCIA_RUNTIME__TELEMETRY__TRACCIA__GOVERNANCE_ENABLED=true
export TRACCIA_RUNTIME__TELEMETRY__TRACCIA__GOVERNANCE_FAIL_OPEN=false
export TRACCIA_RUNTIME__TELEMETRY__TRACCIA__GOVERNANCE_AGENT_ID=virtual-teaching-assistant
python -m examples.virtual_teaching_assistant.dashboard
```
...
telemetry, persistence, and conversation transport live in `src/traccia_runtime`. Only tutor behaviour
