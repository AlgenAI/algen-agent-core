...
retrieval:
  knowledge:
    ...
    table_name: traccia_runtime_documents
...
Install `algen-traccia-runtime[pgvector]`, `[chroma]`, `[faiss]`, or `[qdrant]`. Index dimensions must match
...
Traccia Runtime implements RAG as composition rather than as a special agent type. A versioned agent
