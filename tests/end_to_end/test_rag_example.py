...
from examples.rag_agent.app import AGENT_BY_PROVIDER, EXAMPLE_DIR, parse_args
...
def test_rag_example_configuration_wires_both_model_providers() -> None:
    ...
    assert agents[AGENT_BY_PROVIDER["openai"]].context_builder == (
        "retrieval.company-handbook"
    )
