...
from traccia_runtime.orchestration.container import Container
from traccia_runtime.persistence.memory import InMemoryArtifactStore
        ...
        response = await client.options(
            ...
            headers={
                ...
                "access-control-request-headers": (
                    "content-type,x-tenant-id,x-user-id,x-scopes"
                ),
            },
        )
