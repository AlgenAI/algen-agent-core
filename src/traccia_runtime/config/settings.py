...
from traccia_runtime.cache.contracts import CacheScope
from traccia_runtime.exceptions.errors import ConfigurationError
from traccia_runtime.retrieval.contracts import RetrievalMode, SourceDocument
from traccia_runtime.types.contracts import AgentDefinition, ModelCapabilities
...
class CacheSettings(StrictSettings):
    ...
    key_prefix: str = Field(default="traccia-runtime:cache", min_length=1, max_length=128)
...
class RetrievalSettings(StrictSettings):
    ...
    table_name: str = "traccia_runtime_documents"
...
def load_settings(
    ...
    try:
        ...
        data = _merge(data, _environment("TRACCIA_RUNTIME__"))
