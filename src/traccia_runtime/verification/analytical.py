...
from traccia_runtime.analytics import AnalyticalResult
        ...
        *,
        ...
        for index, claim in enumerate(claims):
            ...
            for evidence in claim.evidence:
                ...
                if result is None or not isinstance(result.value, list) or evidence.row >= len(result.value):
            ...
            if claim.metric and rank.get(claim.metric_certification or "draft", -1) < rank[
                minimum_metric_certification
            ]:
