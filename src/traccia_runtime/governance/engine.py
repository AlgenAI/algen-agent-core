...
from traccia_runtime.governance.contracts import (
    ExportAction,
    GovernanceDecision,
...
class QueryGovernanceEngine:
    ...
    def __init__(self, policy: QueryGovernancePolicy) -> None:
        ...
        self._counter = metrics.get_meter("traccia_runtime.governance").create_counter(
            "traccia_runtime.governance.decisions"
        )
