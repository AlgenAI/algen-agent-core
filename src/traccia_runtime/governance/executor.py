...
from traccia_runtime.exceptions.errors import PolicyDeniedError
from traccia_runtime.governance.contracts import GovernedQueryRequest, QueryEstimate
from traccia_runtime.governance.engine import QueryGovernanceEngine, query_fingerprint
...
class GovernedQueryExecutor:
    ...
    def __init__(
        ...
        *,
        ...
        self._tracer = trace.get_tracer("traccia_runtime.governance")
