...
from traccia_runtime.analytics.contracts import (
    AnalyticalGraph,
...
from traccia_runtime.exceptions.errors import BudgetExceededError, ConfigurationError
...
class AnalyticalGraphEngine:
    ...
    def __init__(
        ...
        *,
        ...
        self._tracer = trace.get_tracer("traccia_runtime.analytics")
        meter = metrics.get_meter("traccia_runtime.analytics")
        self._node_duration = meter.create_histogram(
            "traccia_runtime.analytics.node.duration", unit="ms"
        )
        self._node_runs = meter.create_counter("traccia_runtime.analytics.node.executions")
