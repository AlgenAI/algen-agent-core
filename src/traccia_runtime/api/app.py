...
from traccia_runtime.types.contracts import AgentDefinition, RequestOverrides, RunRequest
...
def create_app(settings: AppSettings | None = None, container: Container | None = None) -> FastAPI:
    ...
    app = FastAPI(title="Traccia Runtime", version="0.1.0", lifespan=lifespan)
    app.state.container = dependencies
