...
from traccia_runtime.exceptions.errors import NotFoundError
...
class PostgresConversationFeedbackStore:
    ...
    async def put(self, feedback: ConversationFeedback) -> ConversationFeedback:
        row = await self._database.fetchrow(
            "INSERT INTO traccia_runtime_conversation_feedback "
    ...
    async def get(
        ...
        row = await self._database.fetchrow(
            "SELECT feedback,id,created_at,updated_at FROM traccia_runtime_conversation_feedback "
...
async def record_feedback(
    *,
    ...
    tracer = trace.get_tracer("traccia_runtime.conversations.feedback")
