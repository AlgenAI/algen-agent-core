...
from traccia_runtime.types.contracts import Role, RunRequest, TextBlock, utc_now
from traccia_runtime.types.interfaces import Runtime
...
class ConversationService:
    ...
    def _forget_task(self, completed: asyncio.Task[None]) -> None:
        if not completed.cancelled() and completed.exception() is not None:
            ...
            structlog.get_logger("traccia_runtime.conversations").error(
