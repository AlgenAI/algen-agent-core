...
from traccia_runtime.types.contracts import Message, RunState


class RedisRunStore:
    def __init__(self, redis: Any, prefix: str = "traccia-runtime") -> None:
        self._redis = redis
        self._prefix = prefix
    ...
    async def list_active(self, limit: int = 1000) -> Sequence[RunState]:
        from traccia_runtime.types.contracts import TERMINAL_STATUSES
...
class RedisMemoryStore:
    def __init__(self, redis: Any, prefix: str = "traccia-runtime", retention_seconds: int = 86400) -> None:
        self._redis = redis
        self._prefix = prefix
