...
from traccia_runtime.distributed.contracts import WorkItem, WorkQueue
...
class DistributedWorker:
    def __init__(self, worker_id: str, queue: WorkQueue, *, lease_seconds: int = 30) -> None:
        ...
        self._tracer = trace.get_tracer("traccia_runtime.distributed")
        self._counter = metrics.get_meter("traccia_runtime.distributed").create_counter(
            "traccia_runtime.work.executions"
        )
