...
from traccia_runtime.types.contracts import AgentDefinition, RunState
from traccia_runtime.types.interfaces import Planner
        ...
        return Plan(
            actions=(
                PlannedAction(
                    ...
                    type=action,
                    description="Compose available output" if state.output_text else "Generate response",
                ),
            ),
