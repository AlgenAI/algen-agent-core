...
from agent_core.exceptions.errors import PolicyDeniedError
from agent_core.security.network import validate_outbound_url
from agent_core.tools.contracts import Idempotency, SideEffect, Tool, ToolContext, ToolDefinition
    ...
    *,
    ...
    async def execute(arguments: dict[str, Any], context: ToolContext) -> dict[str, Any]:
        ...
        return {
            ...
            "headers": {key: value for key, value in response.headers.items() if key.lower() in {"content-type", "etag"}},
