...
from agent_core.types.contracts import Message, RunState


class RedisRunStore:
    def __init__(self, redis: Any, prefix: str = "agent-core") -> None:
        self._redis = redis
        self._prefix = prefix
...
class RedisMemoryStore:
    def __init__(self, redis: Any, prefix: str = "agent-core", retention_seconds: int = 86400) -> None:
        self._redis = redis
        self._prefix = prefix
